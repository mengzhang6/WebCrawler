            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">请输入搜索内容</h3>
                    </div>
                    <div class="panel-body">
                        <form role="form" action="<%=path%>/crawler/Question_getQuestionsByKey.action?index=1" method="post">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="搜索内容" name="content" type="text" autofocus>
                                </div>
                                <input class="btn btn-lg btn-success btn-block" type="submit">
                                <%-- <a href="<%=path%>/crawler/Message_getMessagesByKey.action" class="btn btn-lg btn-success btn-block">确定</a> --%>
                            </fieldset>
                        </form>
                    </div>
                </div>
